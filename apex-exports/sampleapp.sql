...
,p_release=>'24.2.13'
,p_default_workspace_id=>135317258829363931976
,p_default_application_id=>212434
,p_default_id_offset=>137514754235676676972
,p_default_owner=>'WKSP_APEXDOTNET'
);
end;
/
 
prompt APPLICATION 212434 - Sample Calendar
--
-- Application Export:
--   Application:     212434
--   Name:            Sample Calendar
--   Date and Time:   21:25 Friday February 13, 2026
--   Exported By:     COMMIT2CLOUD@GITHUB.COM
--   Flashback:       0
...
,p_owner=>nvl(wwv_flow_application_install.get_schema,'WKSP_APEXDOTNET')
...
,p_application_group=>wwv_flow_imp.id(137521439711598813056)
...
,p_authentication_id=>wwv_flow_imp.id(145717988585828370295)
...
wwv_flow_imp_shared.create_user_interface(
 p_id=>wwv_flow_imp.id(212434)
,p_theme_id=>42
,p_home_url=>'f?p=&APP_ID.:1:&SESSION.'
,p_theme_style_by_user_pref=>true
,p_navigation_list_id=>wwv_flow_imp.id(139221769100698583505)
,p_navigation_list_position=>'SIDE'
,p_navigation_list_template_id=>2467739217141810545
,p_nav_list_template_options=>'#DEFAULT#:js-defaultCollapsed:js-navCollapsed--hidden:t-TreeNav--styleA'
,p_css_file_urls=>'#IMAGE_PREFIX#pkgapp_ui/css/5.0#MIN#.css'
,p_nav_bar_type=>'LIST'
,p_nav_bar_list_id=>wwv_flow_imp.id(139221783686179692857)
...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(138306880691717623749)
,p_name=>'Standard Calendars'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138306880923880623750)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138306881343631623751)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138306881671648623751)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138306882158722623751)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138306882507685623752)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138144944245895289500)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(138306885905583676576)
,p_name=>'Calendars and Dynamic Actions'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138306886113960676577)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138306886517817676577)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138306886891564676577)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138306921734595045377)
,p_list_item_display_sequence=>40
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138495452188542138032)
,p_list_item_display_sequence=>50
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(138306891069441734580)
,p_name=>'Calendars and Javascript'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138306891276360734581)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138306891716493734582)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138306892086787734582)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138310989698195963519)
,p_list_item_display_sequence=>40
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(138306896709672779778)
,p_name=>'Calendar Styling'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138306896951899779778)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138306897278377779779)
,p_list_item_display_sequence=>20
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(138364671994168986394)
,p_name=>'Custom Calendar Initialization'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138364672191770986395)
,p_list_item_display_sequence=>10
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(139221769100698583505)
,p_name=>'Navigation Menu'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138302922595555213612)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138302992368820494775)
,p_list_item_display_sequence=>90
,p_list_item_link_text=>'Monthly Calendar: Projects'
,p_list_item_link_target=>'f?p=&APP_ID.:31:&SESSION.::&DEBUG.::::'
,p_parent_list_item_id=>wwv_flow_imp.id(138302922595555213612)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138293609829508761993)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138300202347904050311)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138302928751415233252)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138306812058982991294)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138133726398381293316)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138302934599972275650)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138302940311440287722)
,p_list_item_display_sequence=>140
,p_list_item_link_text=>'Calendar and Report'
,p_list_item_link_target=>'f?p=&APP_ID.:51:&SESSION.::&DEBUG.'
,p_parent_list_item_id=>wwv_flow_imp.id(138302934599972275650)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'51'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138302953684986301469)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138302968956202380947)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138306913936569000062)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138408574168662056055)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138302992961260521086)
,p_list_item_display_sequence=>40
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138302993765356545737)
,p_list_item_display_sequence=>190
,p_list_item_link_text=>'Custom Navigation'
,p_list_item_link_target=>'f?p=&APP_ID.:71:&SESSION.::&DEBUG.'
,p_parent_list_item_id=>wwv_flow_imp.id(138302992961260521086)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'71'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138303020277471737840)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138303121142557911364)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138310944846382413498)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138364669879381973050)
,p_list_item_display_sequence=>60
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138364656315165849162)
,p_list_item_display_sequence=>300
,p_list_item_link_text=>'Weekly schedule'
,p_list_item_link_target=>'f?p=&APP_ID.:111:&SESSION.::&DEBUG.::::'
,p_parent_list_item_id=>wwv_flow_imp.id(138364669879381973050)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'111'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138303091193442597249)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138303092004727605027)
,p_list_item_display_sequence=>230
,p_list_item_link_text=>'Custom CSS Classes'
,p_list_item_link_target=>'f?p=&APP_ID.:91:&SESSION.::&DEBUG.'
,p_parent_list_item_id=>wwv_flow_imp.id(138303091193442597249)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'91'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138303098830040691932)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(139224989513087084947)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(139221783686179692857)
,p_name=>'Navigation Bar (Top)'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(139221783867630692859)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(139221784262979692953)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(139221784654847692953)
,p_list_item_display_sequence=>50
,p_list_item_link_text=>'Sign Out'
,p_list_item_link_target=>'&LOGOUT_URL.'
,p_parent_list_item_id=>wwv_flow_imp.id(139221784262979692953)
,p_list_item_current_type=>'TARGET_PAGE'
);
end;
/
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(139387116044492332835)
,p_name=>'Administration'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(139387116363543332838)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(139387116712967332839)
,p_list_item_display_sequence=>20
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(140100449369127169371)
,p_name=>'Home Page List'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(140935501357586704938)
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Standard Calendars'
,p_list_item_link_target=>'f?p=&APP_ID.:30:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-calendar'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(140932269573734144871)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(140932269588562144871)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(140932269725711144871)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'Calendar Styling'
,p_list_item_link_target=>'f?p=&APP_ID.:90:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-paint-brush'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(138306850679249314358)
,p_list_item_display_sequence=>60
,p_list_item_link_text=>'Administration'
,p_list_item_link_target=>'f?p=&APP_ID.:15:&SESSION.::&DEBUG.::::'
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(138055013469609707410)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(138055013603849707420)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(138055013900662707457)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(137524552763180735828)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_BOSS'
,p_version_scn=>186626129
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(137526073966629255143)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(137526103645121216490)
,p_plugin_type=>'DYNAMIC ACTION'
,p_plugin=>'NATIVE_OPEN_AI_ASSISTANT'
,p_version_scn=>37167665069464
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(137526104067096216491)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(137526126799631062106)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(137624398322409624724)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(137645950734846115606)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(137647767536502214286)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(137700683141020242640)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(138131336735164444369)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_ADFBC'
,p_version_scn=>37166093867981
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(138645782261421242358)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(139292146116512127228)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(139358846257578409328)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(139444761259356355374)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_icon_bar_item(
 p_id=>wwv_flow_imp.id(140724082964440004605)
,p_icon_sequence=>10
...
wwv_flow_imp_shared.create_icon_bar_item(
 p_id=>wwv_flow_imp.id(140724082359938003278)
,p_icon_sequence=>20
,p_icon_subtext=>'Help'
...
wwv_flow_imp_shared.create_icon_bar_item(
 p_id=>wwv_flow_imp.id(145717988097146370293)
,p_icon_sequence=>30
...
wwv_flow_imp_shared.create_toplevel_tab(
 p_id=>wwv_flow_imp.id(140690034943155455698)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(140096755773470583930)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(138302918167956190168)
,p_lov_name=>'SESSION_TYPES'
,p_lov_query=>'.'||wwv_flow_imp.id(138302918167956190168)||'.'
,p_location=>'STATIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(138302918531467190168)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Business'
,p_lov_return_value=>'BUSINESS'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(138302918870832190170)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Technical'
,p_lov_return_value=>'TECHNICAL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(138302919283173190170)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'General Session'
,p_lov_return_value=>'GENERAL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(138302919742027190170)
,p_lov_disp_sequence=>4
,p_lov_disp_value=>'Break'
,p_lov_return_value=>'BREAK'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(138302920124275190171)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(137847515969015303407)
,p_lov_name=>'STATUS'
,p_lov_query=>'.'||wwv_flow_imp.id(137847515969015303407)||'.'
,p_location=>'STATIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(137847516202725303408)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Active'
,p_lov_return_value=>'ACTIVE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(137847516687686303408)
,p_lov_disp_sequence=>2
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(140175811055573956481)
,p_lov_name=>'VALID STATUS CODES'
,p_lov_query=>'.'||wwv_flow_imp.id(140175811055573956481)||'.'
,p_location=>'STATIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(140175811263318956484)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Closed'
,p_lov_return_value=>'Closed'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(140175811448029956492)
,p_lov_disp_sequence=>20
,p_lov_disp_value=>'On-Hold'
,p_lov_return_value=>'On-Hold'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(140175811643592956492)
,p_lov_disp_sequence=>30
,p_lov_disp_value=>'Open'
,p_lov_return_value=>'Open'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(140175811853296956492)
...
wwv_flow_imp_shared.create_menu(
 p_id=>wwv_flow_imp.id(145717989886679370305)
,p_name=>' Breadcrumb'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(138133728462860293364)
,p_parent_id=>wwv_flow_imp.id(138306885060039656505)
,p_short_name=>'Faceted Search: Projects'
,p_link=>'f?p=&APP_ID.:36:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>36
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(138306863556015405907)
,p_parent_id=>wwv_flow_imp.id(138306885060039656505)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(138306863792589417752)
,p_parent_id=>wwv_flow_imp.id(138306885060039656505)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(138306863993927419795)
,p_parent_id=>wwv_flow_imp.id(138306885060039656505)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(138306864200667421499)
,p_parent_id=>wwv_flow_imp.id(138306885060039656505)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(138306864379171422664)
,p_parent_id=>wwv_flow_imp.id(138306885060039656505)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(138306864631016426517)
,p_parent_id=>wwv_flow_imp.id(138306890108117719633)
,p_short_name=>'Calendar and Report'
,p_link=>'f?p=&APP_ID.:51:&SESSION.::&DEBUG.:::'
,p_page_id=>51
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(138306864801163428279)
,p_parent_id=>wwv_flow_imp.id(138306890108117719633)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(138306865027100430444)
,p_parent_id=>wwv_flow_imp.id(138306890108117719633)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(138306865225236432767)
,p_parent_id=>wwv_flow_imp.id(138306896249137770234)
,p_short_name=>'Custom Navigation'
,p_link=>'f?p=&APP_ID.:71:&SESSION.::&DEBUG.:::'
,p_page_id=>71
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(138306865380413434967)
,p_parent_id=>wwv_flow_imp.id(138306896249137770234)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(138306865646149436089)
,p_parent_id=>wwv_flow_imp.id(138306896249137770234)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(138306865774552438427)
,p_parent_id=>wwv_flow_imp.id(138306900273273802311)
,p_short_name=>'Custom CSS Classes'
,p_link=>'f?p=&APP_ID.:91:&SESSION.::&DEBUG.:::'
,p_page_id=>91
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(138306866014195440103)
,p_parent_id=>wwv_flow_imp.id(138306900273273802311)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(138342075138792366321)
,p_parent_id=>wwv_flow_imp.id(138306890108117719633)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(138364674627079007889)
,p_short_name=>'Custom Calendar Initialization'
,p_link=>'f?p=&APP_ID.:110:&SESSION.::&DEBUG.:::'
,p_page_id=>110
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(138364674860224011154)
,p_parent_id=>wwv_flow_imp.id(138364674627079007889)
,p_short_name=>'Custom weekly schedule'
,p_link=>'f?p=&APP_ID.:111:&SESSION.::&DEBUG.:::'
,p_page_id=>111
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(138409765465376109906)
,p_parent_id=>wwv_flow_imp.id(138306896249137770234)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(138827792470920091422)
,p_short_name=>'Mini Calendar'
,p_link=>'f?p=&APP_ID.:13:&SESSION.::&DEBUG.:::'
,p_page_id=>13
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(138827793144083091426)
,p_parent_id=>wwv_flow_imp.id(138827792470920091422)
,p_short_name=>'&P14_PROJECT.'
,p_link=>'f?p=&APP_ID.:14:&SESSION.::&DEBUG.:::'
,p_page_id=>14
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(139386634300283848582)
,p_parent_id=>wwv_flow_imp.id(139387115783224332831)
,p_short_name=>'Application Theme Style'
,p_link=>'f?p=&APP_ID.:8:&SESSION.::&DEBUG.:::'
,p_page_id=>8
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(139387115783224332831)
,p_short_name=>'Administration'
,p_link=>'f?p=&APP_ID.:15:&SESSION.'
,p_page_id=>15
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(140094938671492334217)
,p_short_name=>'Calendar Entry'
,p_link=>'f?p=&APP_ID.:3:&SESSION.::&DEBUG.:::'
,p_page_id=>3
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(140095347348024417758)
,p_short_name=>'Time Line'
,p_link=>'f?p=&APP_ID.:4:&SESSION.::&DEBUG.:::'
,p_page_id=>4
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(140108070350580256558)
,p_parent_id=>wwv_flow_imp.id(139387115783224332831)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(140109682052273476478)
,p_parent_id=>wwv_flow_imp.id(140108070350580256558)
,p_short_name=>'Report'
,p_link=>'f?p=&APP_ID.:7:&SESSION.'
,p_page_id=>7
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(140175406445206893498)
,p_short_name=>'Project Due Dates'
,p_link=>'f?p=&APP_ID.:9:&SESSION.::&DEBUG.:::'
,p_page_id=>9
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(140175406774882893499)
,p_parent_id=>wwv_flow_imp.id(140175406445206893498)
,p_short_name=>'Project Detail'
,p_link=>'f?p=&FLOW_ID.:10:&SESSION.'
,p_page_id=>10
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(140764859262418404122)
,p_short_name=>'Help'
,p_link=>'f?p=&FLOW_ID.:12:&SESSION.'
,p_page_id=>12
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(145717990298527370308)
,p_short_name=>'Home'
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(140688973747350874851)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(137667264868596077389)
,p_plug_template_id=>wwv_flow_imp.id(140688973747350874851)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(137667264912146077389)
,p_plug_template_id=>wwv_flow_imp.id(140688973747350874851)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(137667265019053077389)
,p_plug_template_id=>wwv_flow_imp.id(140688973747350874851)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(137667265121198077389)
,p_plug_template_id=>wwv_flow_imp.id(140688973747350874851)
,p_name=>'Expand'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(137667265242354077389)
,p_plug_template_id=>wwv_flow_imp.id(140688973747350874851)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(137667265346020077389)
,p_plug_template_id=>wwv_flow_imp.id(140688973747350874851)
,p_name=>'Create2'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(137667265493614077389)
,p_plug_template_id=>wwv_flow_imp.id(140688973747350874851)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(137667265590579077389)
,p_plug_template_id=>wwv_flow_imp.id(140688973747350874851)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(137667265596670077389)
,p_plug_template_id=>wwv_flow_imp.id(140688973747350874851)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(137667265730735077389)
,p_plug_template_id=>wwv_flow_imp.id(140688973747350874851)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(137667265797622077389)
,p_plug_template_id=>wwv_flow_imp.id(140688973747350874851)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(137667265968123077389)
,p_plug_template_id=>wwv_flow_imp.id(140688973747350874851)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(137667266075413077389)
,p_plug_template_id=>wwv_flow_imp.id(140688973747350874851)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_theme(
 p_id=>wwv_flow_imp.id(139221726161722462412)
,p_theme_id=>42
...
,p_default_header_template=>wwv_flow_imp.id(139221691461372462295)
,p_default_footer_template=>wwv_flow_imp.id(139221691461372462295)
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(137542419836685074058)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(137542423812138074060)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(137542425851462074061)
,p_theme_id=>42
,p_name=>'ICON_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(137542429053389074063)
,p_theme_id=>42
,p_name=>'DISPLAY_MODE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(137542437383465074069)
,p_theme_id=>42
,p_name=>'DISPLAY_MODE'
,p_display_name=>'Display Mode'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(137542447306042074075)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(137542451318103074078)
,p_theme_id=>42
,p_name=>'COLOR_ACCENTS'
,p_display_name=>'Color Accents'
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495178436442414900)
,p_theme_id=>142
,p_name=>'ALERT_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495178753277414900)
,p_theme_id=>142
,p_name=>'DISPLAY_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495180603013414905)
,p_theme_id=>142
,p_name=>'REGION_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495180965276414905)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495182759793414908)
,p_theme_id=>142
,p_name=>'BODY_HEIGHT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495183221094414908)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495183483312414909)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495184622020414909)
,p_theme_id=>142
,p_name=>'REGION_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495185601039414910)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495186273531414911)
,p_theme_id=>142
,p_name=>'BADGE_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495186613223414911)
,p_theme_id=>142
,p_name=>'LAYOUT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495188666666414916)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495189125564414916)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495189426472414916)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495190841234414919)
,p_theme_id=>142
,p_name=>'LAYOUT'
,p_display_name=>'Layout'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495191759580414921)
,p_theme_id=>142
,p_name=>'BADGE_SIZE'
,p_display_name=>'Badge Size'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495193182793414922)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495194321519414923)
,p_theme_id=>142
,p_name=>'ICON_STYLE'
,p_display_name=>'Icon Style'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495196167466414928)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495197274958414930)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495198004791414932)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495199293488414935)
,p_theme_id=>142
,p_name=>'BUTTON_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495199625850414935)
,p_theme_id=>142
,p_name=>'SPACING_LEFT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495199955908414935)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495200307147414935)
,p_theme_id=>142
,p_name=>'BUTTON_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495200598227414935)
,p_theme_id=>142
,p_name=>'BUTTON_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495201137123414935)
,p_theme_id=>142
,p_name=>'BUTTON_SET'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495201874170414935)
,p_theme_id=>142
,p_name=>'BUTTON_WIDTH'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495202391568414936)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495202912655414936)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495203176322414936)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495203519106414936)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138495203832849414936)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138559311487902774829)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138582064619373857570)
,p_theme_id=>142
,p_name=>'CURRENT_PAGE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138741273594341429554)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138741279391973429566)
,p_theme_id=>142
,p_name=>'LIST_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138778125383032657439)
,p_theme_id=>142
,p_name=>'DIALOG_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138778127809995657441)
,p_theme_id=>142
,p_name=>'DISPLAY'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138778146926695657466)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138864901723471679347)
,p_theme_id=>142
,p_name=>'LABEL_WIDTH'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(138868428869706036721)
,p_theme_id=>142
,p_name=>'REGION_TITLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(139044677976859126017)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(140690034453497430285)
,p_name=>'ADMINISTRATION'
,p_message_text=>'Administration'
,p_version_scn=>37166093867993
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(140092719670682081595)
,p_name=>'HELP'
,p_message_text=>'Help'
,p_version_scn=>37166093867993
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(140092711668605080975)
,p_name=>'LOGOUT'
,p_message_text=>'Logout'
,p_version_scn=>37166093867993
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(140200803168774557512)
,p_name=>'USER'
,p_message_text=>'User'
,p_version_scn=>37166093867993
);
...
wwv_flow_imp_shared.create_shortcut(
 p_id=>wwv_flow_imp.id(140175399853690893456)
...
wwv_flow_imp_shared.create_authentication(
 p_id=>wwv_flow_imp.id(145717988585828370295)
,p_name=>'APEX Auth'
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(138824087368160744155)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(141538460362524740637)
,p_plugin_id=>wwv_flow_imp.id(138824087368160744155)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(141538460590665740642)
,p_plugin_id=>wwv_flow_imp.id(138824087368160744155)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(141538461023738740642)
,p_plugin_id=>wwv_flow_imp.id(138824087368160744155)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(141538461388682740642)
,p_plugin_id=>wwv_flow_imp.id(138824087368160744155)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(141538461843374740643)
,p_plugin_id=>wwv_flow_imp.id(138824087368160744155)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(141538462207068740643)
,p_plugin_id=>wwv_flow_imp.id(138824087368160744155)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(141538462622076740643)
,p_plugin_id=>wwv_flow_imp.id(138824087368160744155)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(141538463001950740643)
,p_plugin_id=>wwv_flow_imp.id(138824087368160744155)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(141538463422342740644)
,p_plugin_id=>wwv_flow_imp.id(138824087368160744155)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(141538463788033740644)
,p_plugin_id=>wwv_flow_imp.id(138824087368160744155)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(141538464258338740645)
,p_plugin_id=>wwv_flow_imp.id(138824087368160744155)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(141538465169403740668)
,p_plugin_id=>wwv_flow_imp.id(138824087368160744155)
,p_name=>'SOURCE_SQL'
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(141538465942632740676)
,p_plugin_id=>wwv_flow_imp.id(138824087368160744155)
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(138844800852720319519)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(138133418723019054990)
,p_plugin_id=>wwv_flow_imp.id(138844800852720319519)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_static_id=>'attribute_01'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(138133419145889054991)
,p_plugin_id=>wwv_flow_imp.id(138844800852720319519)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(138981378744034490313)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(137687201198822613444)
,p_plugin_id=>wwv_flow_imp.id(138981378744034490313)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_static_id=>'attribute_01'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(137687201612263613444)
,p_plugin_id=>wwv_flow_imp.id(138981378744034490313)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(137687202895858613445)
,p_plugin_id=>wwv_flow_imp.id(138981378744034490313)
,p_name=>'SOURCE_SQL'
...
begin
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(137687203667094613448)
,p_plugin_id=>wwv_flow_imp.id(138981378744034490313)
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(139185823280996737621)
,p_plugin_type=>'REGION TYPE'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(139237133116836338570)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(137666041423589543999)
,p_plugin_id=>wwv_flow_imp.id(139237133116836338570)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_static_id=>'attribute_01'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(137666041813340544000)
,p_plugin_id=>wwv_flow_imp.id(139237133116836338570)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(137666042278945544000)
,p_plugin_id=>wwv_flow_imp.id(139237133116836338570)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(137666042678902544000)
,p_plugin_id=>wwv_flow_imp.id(139237133116836338570)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(137666043050133544000)
,p_plugin_id=>wwv_flow_imp.id(139237133116836338570)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(137666043397837544000)
,p_plugin_id=>wwv_flow_imp.id(139237133116836338570)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(137666043800832544001)
,p_plugin_id=>wwv_flow_imp.id(139237133116836338570)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(137666044280378544001)
,p_plugin_id=>wwv_flow_imp.id(139237133116836338570)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(137666044622423544001)
,p_plugin_id=>wwv_flow_imp.id(139237133116836338570)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>9
,p_display_sequence=>90
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(137666045072753544001)
,p_plugin_id=>wwv_flow_imp.id(139237133116836338570)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>10
,p_display_sequence=>100
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(137666045400098544001)
,p_plugin_id=>wwv_flow_imp.id(139237133116836338570)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>11
,p_display_sequence=>110
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(137666045830748544001)
,p_plugin_id=>wwv_flow_imp.id(139237133116836338570)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(137666046216245544002)
,p_plugin_attribute_id=>wwv_flow_imp.id(137666045830748544001)
,p_display_sequence=>10
,p_display_value=>'Timeline'
,p_return_value=>'D'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(137666046699221544002)
,p_plugin_attribute_id=>wwv_flow_imp.id(137666045830748544001)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(137666047200075544002)
,p_plugin_id=>wwv_flow_imp.id(139237133116836338570)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(137666047657245544002)
,p_plugin_id=>wwv_flow_imp.id(139237133116836338570)
,p_attribute_scope=>'COMPONENT'
...
,p_column_data_types=>'VARCHAR2'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(137666041813340544000)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'NOT_NULL'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(137666048005697544003)
,p_plugin_id=>wwv_flow_imp.id(139237133116836338570)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(137666049308003544004)
,p_plugin_id=>wwv_flow_imp.id(139237133116836338570)
,p_name=>'SOURCE_SQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138822058743238095033)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(139185823491132743369)
,p_plug_name=>'Footer'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(139647863879914187162)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140100450463753169375)
...
,p_list_id=>wwv_flow_imp.id(140100449369127169371)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138306841996995217562)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140094933549047334178)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(140094933762372334179)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(138306841996995217562)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(140804192460518406707)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(140094933945576334179)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(139149957579951800406)
,p_name=>'P3_LASTVIEW'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(140094933549047334178)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(140094934365568334186)
,p_name=>'P3_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(140094933549047334178)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(140094934545424334197)
,p_name=>'P3_TASK_NAME'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(140094933549047334178)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(140094934770143334200)
,p_name=>'P3_END_DATE'
,p_is_required=>true
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(140094933549047334178)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(140109529448636459720)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(140804191454558149517)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(140804193875334505580)
,p_name=>'P3_PROJECT'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(140094933549047334178)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(140804194657635547839)
,p_name=>'P3_STATUS'
,p_is_required=>true
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(140094933549047334178)
...
,p_lov=>'.'||wwv_flow_imp.id(140175811055573956481)||'.'
,p_lov_display_null=>'YES'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(139416255435509874806)
...
,p_associated_item=>wwv_flow_imp.id(140094934770143334200)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(140801480153080016755)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(140801480443285016775)
,p_event_id=>wwv_flow_imp.id(140801480153080016755)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(140094935370727334203)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(140094935561338334204)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(138306842079652217563)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138824122869298728128)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(139149955652744800386)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(139149955761670800387)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'ID'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(139149955781306800388)
,p_name=>'THE_LINK'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(139149955964281800390)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(139149956354864800393)
,p_name=>'COST'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'COST'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(139149956431038800394)
,p_name=>'END_DATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(139149956852726800398)
,p_name=>'PROJECT'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'PROJECT'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(139149956950892800399)
,p_name=>'STATUS'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'STATUS'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(139149956994523800400)
,p_name=>'ASSIGNED_TO'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(139149957129676800401)
,p_name=>'COLOR'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'COLOR'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140095347069841417758)
...
,p_plug_display_sequence=>50
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_imp.id(145717989886679370305)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>4072363345357175094
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140101835461359356317)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(140105546345530834292)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(140095347069841417758)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(140101835645779356319)
,p_name=>'P4_PROJECTS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(140101835461359356317)
,p_item_default=>'0'
,p_prompt=>'Project'
,p_source=>'0'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140108070075382256557)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140696184467364548359)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(139651056581389239672)
,p_plug_name=>'Buttons'
,p_parent_plug_id=>wwv_flow_imp.id(140696184467364548359)
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noPadding:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(140110065349769516870)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(139651056581389239672)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(140108136245886260202)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(139651056581389239672)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(140797577357988741637)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(139651056581389239672)
,p_button_name=>'CANCEL'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(140108194963201265197)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(140108156251080261762)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(140108136245886260202)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140109681748591476475)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140109682160970476478)
,p_plug_name=>'Report'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(140109682243279476478)
,p_name=>'Report'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(140109682452834476482)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(140109682551531476484)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(140109682647681476484)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(140109682746407476484)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(140109682869893476484)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(140109682960266476484)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(140109683065807476484)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(140109683147795476484)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(140109683269560476484)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(140109683355016476484)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(140109691274394476639)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(140110145869508522560)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(140109682160970476478)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(139386630082511848578)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(139386630483813848578)
,p_plug_name=>'About this page'
,p_parent_plug_id=>wwv_flow_imp.id(139386630082511848578)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(139386630895335848579)
,p_plug_name=>'items'
,p_parent_plug_id=>wwv_flow_imp.id(139386630082511848578)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(139386633913887848582)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(139386632089705848580)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(139386633913887848582)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(139386632507587848581)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(139386633913887848582)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(139386634983146848585)
,p_branch_action=>'f?p=&APP_ID.:settings:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(139386632507587848581)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138495442334894054864)
,p_name=>'P8_ENABLE_USER_STYLE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(139386630895335848579)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(139386631324334848579)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(139386634470850848583)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(139386632507587848581)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138824127855848828311)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(139711490252606693169)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138844808952214410945)
,p_plug_name=>'SQL Source'
,p_parent_plug_id=>wwv_flow_imp.id(139711490252606693169)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140175404544110893487)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(140175404758829893488)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(140175404854534893494)
,p_db_column_name=>'ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'ID'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(140175404944792893495)
,p_db_column_name=>'ROW_VERSION_NUMBER'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Row Version Number'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(140175405070275893495)
,p_db_column_name=>'PROJECT'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Project'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(140175405157284893496)
,p_db_column_name=>'TASK_NAME'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Task Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(140175405251722893496)
,p_db_column_name=>'START_DATE'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Start Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(140175405367174893496)
,p_db_column_name=>'END_DATE'
,p_display_order=>6
,p_column_identifier=>'F'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(140175405465546893497)
,p_db_column_name=>'STATUS'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Status'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(140175405555139893497)
,p_db_column_name=>'ASSIGNED_TO'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'Assigned To'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(140175405657187893497)
,p_db_column_name=>'COST'
,p_display_order=>9
,p_column_identifier=>'I'
,p_column_label=>'Cost'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(140175405756508893497)
,p_db_column_name=>'BUDGET'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'Budget'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(140175486755610909159)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(140175486867021909160)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(140175410767815893718)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140175406070242893498)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(140175657657604928628)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(140175406070242893498)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--iconLeft'
,p_button_template_id=>2082829544945815391
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(140175405975372893497)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(140175406070242893498)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(139149957369608800404)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140175399049479893448)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(140175399474760893449)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(139149957369608800404)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(140175399372160893449)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(139149957369608800404)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(140175399248743893449)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(139149957369608800404)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(140175399653810893449)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(139149957369608800404)
,p_button_name=>'CANCEL'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(140175400574368893462)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(140175400747290893463)
,p_name=>'P10_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(140175399049479893448)
,p_use_cache_before_default=>'NO'
,p_source=>'ID'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(140175400963956893465)
,p_name=>'P10_PROJECT'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(140175399049479893448)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(140175401173672893466)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(140175401359018893467)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(140175401565347893467)
,p_name=>'P10_END_DATE'
,p_is_required=>true
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(140175399049479893448)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(140175401771716893467)
,p_name=>'P10_STATUS'
,p_is_required=>true
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(140175399049479893448)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(140175401973360893467)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(140175402174548893467)
,p_name=>'P10_COST'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(140175399049479893448)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(140175402346967893469)
,p_name=>'P10_BUDGET'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(140175399049479893448)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(137753577515291779276)
,p_name=>'Cancel Modal'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(140175399653810893449)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(137753577635370779277)
,p_event_id=>wwv_flow_imp.id(137753577515291779276)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(140175403553632893476)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from EBA_DEMO_CAL_PROJECTS'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(140175403750826893478)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of EBA_DEMO_CAL_PROJECTS'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(140175403973650893479)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(140175399474760893449)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(139573383969010864490)
,p_name=>'&APP_NAME.'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(139573384140577864491)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(139573384257209864492)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(139573384299890864493)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140764857452107404109)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140764857844901404113)
,p_plug_name=>'Quick Start'
,p_parent_plug_id=>wwv_flow_imp.id(140764857452107404109)
,p_plug_display_sequence=>30
,p_plug_display_point=>'SUB_REGIONS'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140764858073403404118)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140764858251734404118)
,p_plug_name=>'About this Application'
,p_parent_plug_id=>wwv_flow_imp.id(140764857452107404109)
,p_plug_display_sequence=>20
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140764858865741404120)
,p_plug_name=>'Help'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138827791049937091416)
,p_plug_name=>'Report'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2100526641005906379
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(138827791263344091416)
,p_name=>'Report'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(138827791370568091419)
,p_db_column_name=>'ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'ID'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(138827791469275091421)
,p_db_column_name=>'PROJECT'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Project'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(138827791575305091421)
,p_db_column_name=>'TASK_NAME'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Task Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(138827791657523091421)
,p_db_column_name=>'START_DATE'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Start Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(138827791760181091421)
,p_db_column_name=>'END_DATE'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'End Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(138827791875275091421)
,p_db_column_name=>'STATUS'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Status'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(138827791966601091422)
,p_db_column_name=>'ASSIGNED_TO'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Assigned To'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(138827792061789091422)
,p_db_column_name=>'COST'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'Cost'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(138827792151635091422)
,p_db_column_name=>'BUDGET'
,p_display_order=>9
,p_column_identifier=>'I'
,p_column_label=>'Budget'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(138827799366592093047)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138827792656633091425)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138828132954827165337)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(138828430448687220362)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(138827791049937091416)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>2349107722467437027
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138827786255424091392)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138827792962616091425)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138828456671290283634)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138981382557608499202)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138981382745100504988)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(138827786770299091393)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(138827792962616091425)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(138827787073505091393)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138827787245028091394)
,p_name=>'P14_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(138828456671290283634)
,p_use_cache_before_default=>'NO'
,p_source=>'ID'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138827787469367091404)
,p_name=>'P14_PROJECT'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(138827786255424091392)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Project'
,p_source=>'PROJECT'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138827787660405091404)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138827787863524091404)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138827788072305091405)
,p_name=>'P14_END_DATE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(138827786255424091392)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138827788252504091405)
,p_name=>'P14_STATUS'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(138827786255424091392)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138827788460100091405)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138827788659971091405)
,p_name=>'P14_COST'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(138827786255424091392)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138827788846893091406)
,p_name=>'P14_BUDGET'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(138827786255424091392)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(138827790243372091408)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of EBA_DEMO_CAL_PROJECTS'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(138827790447790091408)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(138827790064986091407)
,p_process_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(139387114180377332822)
...
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>20
,p_list_id=>wwv_flow_imp.id(139387116044492332835)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(139387115420759332830)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138306843706483217579)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140166930198272528476)
,p_plug_name=>'Standard Calendars'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hiddenOverflow:t-Region--hideHeader js-addHiddenHeadingRoleDesc'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>20
,p_list_id=>wwv_flow_imp.id(138306880691717623749)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
end;
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138306842449118217566)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140000924879613212169)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140000926011423212175)
,p_plug_name=>'Tasks'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140000927982845212259)
,p_plug_name=>'Button Bar'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noPadding:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138302988028839483753)
,p_name=>'P31_PROJECTS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(140000927982845212259)
,p_item_default=>'0'
,p_prompt=>'Project'
,p_source=>'0'
,p_source_type=>'STATIC'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138302990154100483756)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138302990629104483757)
,p_event_id=>wwv_flow_imp.id(138302990154100483756)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(140000926011423212175)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138306842233738217564)
,p_name=>'Dialog closed'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(140000926011423212175)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138306842308199217565)
,p_event_id=>wwv_flow_imp.id(138306842233738217564)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138306842496418217567)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(139991547919311490399)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(139991549051121490405)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138293613433609762052)
,p_name=>'Change Project - Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138293613896588762057)
,p_event_id=>wwv_flow_imp.id(138293613433609762052)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(139991549051121490405)
,p_attribute_01=>'N'
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138293122537438908688)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138306842629340217568)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140764686721696125549)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140764687853506125555)
,p_plug_name=>'Sessions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138293122573040908689)
,p_name=>'P33_SHOW_INACTIVE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(138293122537438908688)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138293122274467908686)
,p_name=>'Dialog Closed: Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(140764687853506125555)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138293122412411908687)
,p_event_id=>wwv_flow_imp.id(138293122274467908686)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(140764687853506125555)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138293122751763908690)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138293122840447908691)
,p_event_id=>wwv_flow_imp.id(138293122751763908690)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138306842672860217569)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(139068987763715726752)
,p_plug_name=>'Items Container'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(141540551947972943613)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(141540553079782943619)
,p_plug_name=>'Sessions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138302930042167233256)
,p_name=>'P34_SHOW_INACTIVE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(139068987763715726752)
,p_prompt=>'Show Inactive Sessions'
,p_display_as=>'NATIVE_YES_NO'
,p_field_template=>3031561666792084173
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138302931251132233258)
,p_name=>'Dialog Closed: Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(141540553079782943619)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138302931734040233259)
,p_event_id=>wwv_flow_imp.id(138302931251132233258)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(141540553079782943619)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138302932091185233260)
,p_name=>'Change Show Inactive Sessions'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138302932659995233260)
,p_event_id=>wwv_flow_imp.id(138302932091185233260)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138303002105135555006)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138303002233252555007)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138306842817255217570)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(139848736349586302867)
,p_plug_name=>'Items Container'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(142320300533843519728)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(142320301665653519734)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138303002271680555008)
,p_name=>'P35_SHOW_TIME_FORMAT'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(139848736349586302867)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138306813262902991341)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138306815309071991377)
,p_name=>'Change Show Inactive Sessions'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138306815839979991378)
,p_event_id=>wwv_flow_imp.id(138306815309071991377)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(142320301665653519734)
,p_attribute_01=>'N'
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138133731081214295420)
,p_plug_name=>'Search'
...
,p_filtered_region_id=>wwv_flow_imp.id(140610099928638769629)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138916016366333775020)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140610098796828769623)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140610099928638769629)
,p_plug_name=>'Tasks'
,p_region_name=>'task_due_dates'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138133731165753295421)
,p_name=>'P36_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(138133731081214295420)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138133731283428295422)
,p_name=>'P36_PROJECT'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138133728606993293367)
,p_name=>'Change Project - Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138133729107096293369)
,p_event_id=>wwv_flow_imp.id(138133728606993293367)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(140610099928638769629)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138133729501796293370)
,p_name=>'Dialog closed'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(140610099928638769629)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138133730052671293370)
,p_event_id=>wwv_flow_imp.id(138133729501796293370)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138306843792942217580)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140946755172961822545)
,p_plug_name=>'Calendars and Dynamic Actions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hiddenOverflow:t-Region--hideHeader js-addHiddenHeadingRoleDesc'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>20
,p_list_id=>wwv_flow_imp.id(138306885905583676576)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
end;
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138306842868093217571)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140766941679651528398)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140766942811461528404)
,p_plug_name=>'Tasks'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(139068996814904781219)
,p_name=>'Tasks '
,p_parent_plug_id=>wwv_flow_imp.id(140766942811461528404)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(138302942666335287734)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>1
,p_hidden_column=>'Y'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(138302943076482287734)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(138302943475687287734)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(138302943910833287735)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(138302944274814287739)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(138302944743673287740)
,p_query_column_id=>6
,p_column_alias=>'COST'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(138302945121393287740)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(138302945464421287740)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(138302942283754287732)
,p_query_column_id=>9
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140766944782883528488)
,p_plug_name=>'Button Bar'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138302940984396287728)
,p_name=>'P51_PROJECTS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(140766944782883528488)
,p_item_default=>'0'
,p_prompt=>'Project'
,p_source=>'0'
,p_source_type=>'STATIC'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138302945870316287741)
,p_name=>'P51_CAL_START_DATE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(139068996814904781219)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138302946319874287741)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138302947481609287742)
,p_name=>'Change Project - Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138302948013427287743)
,p_event_id=>wwv_flow_imp.id(138302947481609287742)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(140766942811461528404)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138302948532211287743)
,p_event_id=>wwv_flow_imp.id(138302947481609287742)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(139068996814904781219)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138302948897798287743)
,p_name=>'Calendar View Changed: Refresh Report'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(140766942811461528404)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'NATIVE_CSS_CALENDAR|REGION TYPE|apexcalendarviewchange'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138302949452392287752)
,p_event_id=>wwv_flow_imp.id(138302948897798287743)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138302950422858287764)
,p_event_id=>wwv_flow_imp.id(138302948897798287743)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138302949942123287752)
,p_event_id=>wwv_flow_imp.id(138302948897798287743)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138302950799051287765)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138302951323030287765)
,p_event_id=>wwv_flow_imp.id(138302950799051287765)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138302951824340287766)
,p_event_id=>wwv_flow_imp.id(138302950799051287765)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138302952266191287766)
,p_event_id=>wwv_flow_imp.id(138302950799051287765)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138306842976106217572)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(139069012737684794991)
,p_plug_name=>'Items Container'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(141540576921942011852)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(141540578053752011858)
,p_plug_name=>'Sessions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138293123458099908697)
,p_name=>'P52_ENDDATE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(139069012737684794991)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138293123531997908698)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138302955020388301471)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138302956210964301473)
,p_name=>'Dialog Closed: Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(141540578053752011858)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138302956665063301474)
,p_event_id=>wwv_flow_imp.id(138302956210964301473)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(141540578053752011858)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138302957090780301475)
,p_name=>'Change Show Inactive Sessions'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138302957651960301475)
,p_event_id=>wwv_flow_imp.id(138302957090780301475)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138293123258936908695)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138293123282557908696)
,p_event_id=>wwv_flow_imp.id(138293123258936908695)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138293123653094908699)
,p_event_id=>wwv_flow_imp.id(138293123258936908695)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138293123828265908701)
,p_event_id=>wwv_flow_imp.id(138293123258936908695)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138293123867378908702)
,p_event_id=>wwv_flow_imp.id(138293123258936908695)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138306843110509217573)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(139844918206541760773)
,p_plug_name=>'Items Container'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(142316482390798977634)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(142316483522608977640)
,p_plug_name=>'Sessions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138293124233956908705)
,p_name=>'P53_SESSION_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(139844918206541760773)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138302970171655380951)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138302973140998380954)
,p_name=>'Change Show Inactive Sessions'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138302973574214380954)
,p_event_id=>wwv_flow_imp.id(138302973140998380954)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(142316483522608977640)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138293124055743908703)
,p_name=>'Event Clicked: Confirm and Delete'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(142316483522608977640)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'NATIVE_CSS_CALENDAR|REGION TYPE|apexcalendareventselect'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138293124099525908704)
,p_event_id=>wwv_flow_imp.id(138293124055743908703)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138293124334264908706)
,p_event_id=>wwv_flow_imp.id(138293124055743908703)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138293124408431908707)
,p_event_id=>wwv_flow_imp.id(138293124055743908703)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138293124530951908708)
,p_event_id=>wwv_flow_imp.id(138293124055743908703)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138306844170742217584)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140624768665446345667)
,p_plug_name=>'Items Container'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(143096332849703562528)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(143096333981513562534)
,p_plug_name=>'Sessions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138306915485081000066)
,p_name=>'P54_SHOW_INACTIVE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(140624768665446345667)
,p_prompt=>'Show Inactive Sessions'
,p_display_as=>'NATIVE_YES_NO'
,p_field_template=>3031561666792084173
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138306915884265000075)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138306916548975000076)
,p_name=>'Change Show Inactive Sessions'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138306916979875000080)
,p_event_id=>wwv_flow_imp.id(138306916548975000076)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(143096333981513562534)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138306917369596000081)
,p_name=>'Event Clicked: Confirm and Delete'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(143096333981513562534)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'NATIVE_CSS_CALENDAR|REGION TYPE|apexcalendareventselect'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138306919421459000083)
,p_event_id=>wwv_flow_imp.id(138306917369596000081)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138306918366290000082)
,p_event_id=>wwv_flow_imp.id(138306917369596000081)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138306918872828000082)
,p_event_id=>wwv_flow_imp.id(138306917369596000081)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138306843946485217581)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(141726585490900169843)
,p_plug_name=>'Calendars and Javascript'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hiddenOverflow:t-Region--hideHeader js-addHiddenHeadingRoleDesc'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>20
,p_list_id=>wwv_flow_imp.id(138306891069441734580)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
end;
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138306843182607217574)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140776855242301342739)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140776856374111342745)
,p_plug_name=>'Tasks'
,p_region_name=>'project_tasks'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140776858345533342829)
,p_plug_name=>'Button Bar'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(138303001807643555003)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(140776858345533342829)
,p_button_name=>'TODAY'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(138293124622987908709)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(140776858345533342829)
,p_button_name=>'NEXT'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(138302997854105554963)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(140776858345533342829)
,p_button_name=>'PREV'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138302995087473545739)
,p_name=>'P71_PROJECTS'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(140776858345533342829)
,p_item_default=>'0'
,p_prompt=>'Project'
,p_source=>'0'
,p_source_type=>'STATIC'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138302998344320554968)
,p_name=>'P71_GOTODATE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(140776858345533342829)
,p_prompt=>'Goto date'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138302999872037554984)
,p_name=>'P71_VIEWTYPE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(140776858345533342829)
,p_prompt=>'View Type'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138302996267582545741)
,p_name=>'Change Project - Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138302996838329545741)
,p_event_id=>wwv_flow_imp.id(138302996267582545741)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(140776856374111342745)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138293124757465908710)
,p_name=>'Calendar: Next Month'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(138293124622987908709)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138302997626220554961)
,p_event_id=>wwv_flow_imp.id(138293124757465908710)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138302998156826554966)
,p_name=>'Calendar: Prev Month'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(138302997854105554963)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138302998233865554967)
,p_event_id=>wwv_flow_imp.id(138302998156826554966)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138302998384031554969)
,p_name=>'Focus Date'
,p_event_sequence=>40
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138302998468727554970)
,p_event_id=>wwv_flow_imp.id(138302998384031554969)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138302998800856554973)
,p_event_id=>wwv_flow_imp.id(138302998384031554969)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138303000006831554985)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138303000147878554986)
,p_event_id=>wwv_flow_imp.id(138303000006831554985)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138303000191295554987)
,p_name=>'Change View'
,p_event_sequence=>60
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138303000283838554988)
,p_event_id=>wwv_flow_imp.id(138303000191295554987)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138303001956384555004)
,p_name=>'Set Goto Date to "today"'
,p_event_sequence=>70
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(138303001807643555003)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138303002003154555005)
,p_event_id=>wwv_flow_imp.id(138303001956384555004)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138306843343885217575)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(141552812104251665413)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(141552813236061665419)
,p_plug_name=>'Tasks'
,p_region_name=>'project_tasks'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(141552815207483665503)
,p_plug_name=>'Button Bar'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138302998886580554974)
,p_name=>'P72_END_DATE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(141552815207483665503)
,p_prompt=>'to'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_begin_on_new_line=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138302998981083554975)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138303022394378737842)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138303023995322737845)
,p_name=>'Change Project - Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138303024550299737846)
,p_event_id=>wwv_flow_imp.id(138303023995322737845)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(141552813236061665419)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138302999119291554976)
,p_name=>'Get Calendar Status'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(141552813236061665419)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'NATIVE_CSS_CALENDAR|REGION TYPE|apexcalendarviewchange'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138302999165482554977)
,p_event_id=>wwv_flow_imp.id(138302999119291554976)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138302999298562554978)
,p_event_id=>wwv_flow_imp.id(138302999119291554976)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138302999410898554979)
,p_event_id=>wwv_flow_imp.id(138302999119291554976)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138306841916144217561)
,p_event_id=>wwv_flow_imp.id(138302999119291554976)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138306843458932217576)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(139845070424147291188)
,p_plug_name=>'Items Container'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(142316634608404508049)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(142316635740214508055)
,p_plug_name=>'Sessions'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(138303000676651554992)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(139845070424147291188)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(138303001252024554997)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(139845070424147291188)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138303000622480554991)
,p_name=>'P73_TITLE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(139845070424147291188)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138303001125705554996)
...
,p_lov=>'.'||wwv_flow_imp.id(138302918167956190168)||'.'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_field_template=>3031561666792084173
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138303122841370911374)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138303123230225911374)
,p_name=>'P73_ENDDATE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(139845070424147291188)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138303126180595911378)
,p_name=>'Date Range Selected: Create new Event'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(142316635740214508055)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'NATIVE_CSS_CALENDAR|REGION TYPE|apexcalendardateselect'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138303126668993911378)
,p_event_id=>wwv_flow_imp.id(138303126180595911378)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138303127243800911379)
,p_event_id=>wwv_flow_imp.id(138303126180595911378)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138303001054814554995)
,p_event_id=>wwv_flow_imp.id(138303126180595911378)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
,p_affected_button_id=>wwv_flow_imp.id(138303000676651554992)
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138303000841902554993)
,p_name=>'Create Javascript Event'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(138303000676651554992)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138303000947109554994)
,p_event_id=>wwv_flow_imp.id(138303000841902554993)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138303001280003554998)
,p_name=>'Save Event to Database'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(138303001252024554997)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138303001420782554999)
,p_event_id=>wwv_flow_imp.id(138303001280003554998)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138303001537356555000)
,p_event_id=>wwv_flow_imp.id(138303001280003554998)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(142316635740214508055)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138303001570242555001)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138303001723067555002)
,p_event_id=>wwv_flow_imp.id(138303001570242555001)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138306844303998217585)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138409765092556109896)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140628951798144289473)
,p_plug_name=>'Items Container'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>30
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(143100515982401506334)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(143100517114211506340)
,p_plug_name=>'Sessions'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(138310946374577413536)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(140628951798144289473)
,p_button_name=>'SHOW_IN_CALENDAR'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(138310946764949413538)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(140628951798144289473)
,p_button_name=>'SAVE_IN_DATABASE'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(138310994366230022162)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(140628951798144289473)
,p_button_name=>'CLEAR'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138306844610453217588)
,p_name=>'P74_MY_SESSION_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(138306844303998217585)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138310947195505413538)
,p_name=>'P74_TITLE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(140628951798144289473)
,p_item_default=>'My Session'
,p_prompt=>'Title'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138310947977249413546)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138310948434843413547)
,p_name=>'P74_ENDDATE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(140628951798144289473)
,p_item_default=>'to_char(sysdate, ''YYYY-MM-DD'')||'' 11:00:00'''
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138310954127898413594)
,p_name=>'Create Javascript Event'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(138310946374577413536)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138310954661021413594)
,p_event_id=>wwv_flow_imp.id(138310954127898413594)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138310949008149413579)
,p_name=>'Save Event to Database'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(138310946764949413538)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138310949521550413583)
,p_event_id=>wwv_flow_imp.id(138310949008149413579)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138310950032543413588)
,p_event_id=>wwv_flow_imp.id(138310949008149413579)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(138306844303998217585)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138495442440107054865)
,p_event_id=>wwv_flow_imp.id(138310949008149413579)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138310950426643413588)
,p_name=>'Event Data Changed: Show in Calendar'
,p_event_sequence=>60
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138310950875891413591)
,p_event_id=>wwv_flow_imp.id(138310950426643413588)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(138310946374577413536)
,p_attribute_01=>'apex.event.trigger(this.affectedElements, "click");'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138306844434644217586)
,p_name=>'Event selected: Copy to "My Sessions"'
,p_event_sequence=>70
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(143100517114211506340)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'NATIVE_CSS_CALENDAR|REGION TYPE|apexcalendareventselect'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138306844872767217591)
,p_event_id=>wwv_flow_imp.id(138306844434644217586)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138306844494260217587)
,p_event_id=>wwv_flow_imp.id(138306844434644217586)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138306844836547217590)
,p_event_id=>wwv_flow_imp.id(138306844434644217586)
,p_event_result=>'TRUE'
,p_action_sequence=>50
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138306845022993217592)
,p_event_id=>wwv_flow_imp.id(138306844434644217586)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138306845140798217593)
,p_name=>'Delete Selected Event'
,p_event_sequence=>80
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(138306844303998217585)
,p_triggering_condition_type=>'JAVASCRIPT_EXPRESSION'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138306845345964217595)
,p_event_id=>wwv_flow_imp.id(138306845140798217593)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138306845366486217596)
,p_event_id=>wwv_flow_imp.id(138306845140798217593)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138306845503686217597)
,p_event_id=>wwv_flow_imp.id(138306845140798217593)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138306845604770217598)
,p_event_id=>wwv_flow_imp.id(138306845140798217593)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138306845754363217599)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138306845821905217600)
,p_event_id=>wwv_flow_imp.id(138306845754363217599)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138306845888186217601)
,p_event_id=>wwv_flow_imp.id(138306845754363217599)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138306846028861217602)
,p_event_id=>wwv_flow_imp.id(138306845754363217599)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138306846718638217609)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138306846792237217610)
,p_event_id=>wwv_flow_imp.id(138306846718638217609)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(143100517114211506340)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138310994536984022163)
,p_name=>'Clear Schedule'
,p_event_sequence=>110
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(138310994366230022162)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138310994655103022164)
,p_event_id=>wwv_flow_imp.id(138310994536984022163)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_CONFIRM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138310994695904022165)
,p_event_id=>wwv_flow_imp.id(138310994536984022163)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138310994782606022166)
,p_event_id=>wwv_flow_imp.id(138310994536984022163)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138310994923719022167)
,p_event_id=>wwv_flow_imp.id(138310994536984022163)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138310995226263022170)
,p_name=>'Change topic'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138310995276810022171)
,p_event_id=>wwv_flow_imp.id(138310995226263022170)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(139616639912436704765)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(139616640009887704766)
,p_event_id=>wwv_flow_imp.id(139616639912436704765)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138133731377975295423)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138133731490050295424)
,p_event_id=>wwv_flow_imp.id(138133731377975295423)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138306844019134217582)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(142506420632301552969)
,p_plug_name=>'Calendar Styling'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hiddenOverflow:t-Region--hideHeader js-addHiddenHeadingRoleDesc'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>20
,p_list_id=>wwv_flow_imp.id(138306896709672779778)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
end;
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138306843478801217577)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140767576466265680250)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140767577598075680256)
,p_plug_name=>'Sessions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138303094235071605071)
,p_name=>'Change Project - Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138303094734425605077)
,p_event_id=>wwv_flow_imp.id(138303094235071605071)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(140767577598075680256)
,p_attribute_01=>'N'
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138306843624607217578)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(141543611853381957016)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(141543612985191957022)
,p_plug_name=>'Sessions'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138303100627487691938)
,p_name=>'Change Project - Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138303101077345691939)
,p_event_id=>wwv_flow_imp.id(138303100627487691938)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(141543612985191957022)
,p_attribute_01=>'N'
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(145717989082635370299)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(140651998555283952818)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(145717989082635370299)
,p_button_name=>'LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(145717989195238370303)
,p_name=>'P101_USERNAME'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(145717989082635370299)
,p_prompt=>'Username'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(145717989294964370303)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(140768449845492912578)
,p_name=>'Set Focus'
,p_event_sequence=>10
,p_triggering_condition_type=>'JAVASCRIPT_EXPRESSION'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(140768450166898912579)
,p_event_id=>wwv_flow_imp.id(140768449845492912578)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(140768450346770912579)
,p_event_id=>wwv_flow_imp.id(140768449845492912578)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(145717989570150370305)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(145717989477054370304)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(145717989771974370305)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(145717989667656370305)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138318072673168066292)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(142564192836235734084)
,p_plug_name=>'Custom Calendar Initialization'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hiddenOverflow:t-Region--hideHeader js-addHiddenHeadingRoleDesc'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>20
,p_list_id=>wwv_flow_imp.id(138364671994168986394)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
end;
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138318072764531066293)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(142378169798739445853)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(142378170930549445859)
,p_plug_name=>'Sessions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138364659417195849168)
,p_name=>'Dialog Closed: Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(142378170930549445859)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138364659926004849168)
,p_event_id=>wwv_flow_imp.id(138364659417195849168)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(142378170930549445859)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138364660317025849169)
,p_name=>'Change Show Inactive Sessions'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138364660820914849169)
,p_event_id=>wwv_flow_imp.id(138364660317025849169)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138336911239708550852)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(143259680596026086731)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(143259681727836086737)
,p_plug_name=>'Sessions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138463221749615869907)
,p_name=>'P112_DRAGDROP_MSG'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(143259681727836086737)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138463221304132869903)
,p_name=>'Begin Drag & Drop '
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(143259681727836086737)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138463221460468869904)
,p_event_id=>wwv_flow_imp.id(138463221304132869903)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138463221478071869905)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138463221577471869906)
,p_event_id=>wwv_flow_imp.id(138463221478071869905)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138495442089345054862)
,p_event_id=>wwv_flow_imp.id(138463221478071869905)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138300205436831057812)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138300206133981057813)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(138300206543835057814)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(138300206133981057813)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(138300206011524057813)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(138300206133981057813)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(138300205960746057813)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(138300206133981057813)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(138300205808781057813)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(138300206133981057813)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138300208923708057823)
,p_name=>'P301_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(138300205436831057812)
,p_use_cache_before_default=>'NO'
,p_source=>'ID'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138300209324615057857)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138300209609601057861)
,p_name=>'P301_TITLE'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(138300205436831057812)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138300210048734057861)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138300210405971057862)
,p_name=>'P301_SPEAKER'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(138300205436831057812)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138300210775844057862)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138300211247839057862)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138300211619225057863)
,p_name=>'P301_STATUS'
,p_is_required=>true
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(138300205436831057812)
...
,p_named_lov=>'STATUS'
,p_lov=>'.'||wwv_flow_imp.id(137847515969015303407)||'.'
,p_field_template=>2526760615038828570
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138300206572336057814)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(138300206543835057814)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138300207406184057817)
,p_event_id=>wwv_flow_imp.id(138300206572336057814)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138293122957610908692)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138293123010378908693)
,p_event_id=>wwv_flow_imp.id(138293122957610908692)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138293123124098908694)
,p_event_id=>wwv_flow_imp.id(138293122957610908692)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(138300212455333057869)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(138300212820027057870)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(138300213187768057870)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(138300206011524057813)
,p_internal_uid=>775660993182322051
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(138300213635481057870)
...
wwv_flow_imp_shared.create_install(
 p_id=>wwv_flow_imp.id(140090020869626529523)
...
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(140866827253207611476)
,p_install_id=>wwv_flow_imp.id(140090020869626529523)
...
begin
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(140093942258880201270)
,p_install_id=>wwv_flow_imp.id(140090020869626529523)
...
begin
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(140094013643773206284)
,p_install_id=>wwv_flow_imp.id(140090020869626529523)
,p_name=>'insert data'
,p_sequence=>30
,p_script_type=>'INSTALL'
